...
router.get('/specialOffer', getAllSpecialOffers);
...
router.post('/specialOffer/test', uploads.single('image'), createSpecialOfferTest);
router.post('/specialOffer/upload', uploads.single('image'), uploadSpecialOfferImage);
